...
(function () {
  ...
  function renderFlowList(filter) {
    ...
    root.innerHTML = wrap(GSTYLE + FSTYLE + '<style>' +
      '.fl-table tbody tr.fl-row{cursor:pointer}.fl-table tbody tr.fl-row:hover td{background:#fbfdff}.fl-table tbody tr.fl-row:focus-visible{outline:2px solid var(--brand);outline-offset:-2px}.fl-view-cell{width:52px;text-align:center!important}.fl-view{display:inline-grid;width:30px;height:30px;place-items:center;border:0;border-radius:6px;background:transparent;color:var(--ink-muted);cursor:pointer}.fl-view:hover,.fl-view:focus-visible{background:var(--panel);color:var(--brand);outline:none}.fl-view svg{display:block}' +
